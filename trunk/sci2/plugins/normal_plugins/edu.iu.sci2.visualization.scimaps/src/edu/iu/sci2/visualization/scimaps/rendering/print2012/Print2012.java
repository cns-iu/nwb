...
public class Print2012 {
	...
	public Print2012(MapOfScience mapOfScience, String generatedFrom,
		...
		this(createVisualization(mapOfScience, generatedFrom, size,
				scalingFactor));
	}
	...
	private static RenderableVisualization createVisualization(
			MapOfScience mapOfScience, String generatedFrom, Dimension size,
			float scalingFactor) {
		RenderableVisualization visualization = new DocumentRenderer(
