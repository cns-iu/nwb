...
public class IsiPersonPriorities implements PreferrableFormComparator {
	...
	private List<? extends Comparator<Tuple>> columns = Lists.newArrayList(new LongerColumn(ISI.FULL_NAME), new LongerColumn(ISI.PERSONAL_NAME), new LongerColumn(ISI.UNSPLIT_ABBREVIATED_NAME), new LongerColumn(ISI.MIDDLE_INITIAL));
