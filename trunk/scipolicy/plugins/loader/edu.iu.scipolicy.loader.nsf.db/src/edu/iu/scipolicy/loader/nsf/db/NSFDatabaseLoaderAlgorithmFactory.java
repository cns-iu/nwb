...
public class NSFDatabaseLoaderAlgorithmFactory implements AlgorithmFactory, ParameterMutator {
	...
	*/}
	...
	public ObjectClassDefinition mutateParameters(Data[] data, 
		...
		for (AttributeDefinition oldAttributeDefinition : oldAttributeDefinitions) {
			 ...
			 * */
			if (oldAttributeDefinitionID.equals(NSFDatabaseLoaderAlgorithm.AGGREGATE_ON_COLUMN)) {
