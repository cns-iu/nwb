// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g 2009-11-18 17:17:53
...
public class DefaultSpecializers extends TreeRewriteSequence {
    ...
    public final DefaultSpecializers.function_return function() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: args, FUNCTION, op, target
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: type, rules, layer, GUIDE
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: base, OPERATOR_REFERENCE
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
