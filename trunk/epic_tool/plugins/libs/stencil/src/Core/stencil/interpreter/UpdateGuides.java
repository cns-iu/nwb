// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g 2009-11-18 17:18:15
...
public class UpdateGuides extends TreeFilter {
    ...
    // $ANTLR start "topdown"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:124:1: topdown : ^(att= GUIDE layer= ID type= . spec= . rules= . callChain[$layer.text, $att.text] ) ;
    public final void topdown() throws RecognitionException {
        ...
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:124:8: ( ^(att= GUIDE layer= ID type= . spec= . rules= . callChain[$layer.text, $att.text] ) )
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:124:10: ^(att= GUIDE layer= ID type= . spec= . rules= . callChain[$layer.text, $att.text] )
            {
    ...
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:126:1: callChain[String layerName, String att] : ^( CALL_CHAIN invoke[layerName, att] ) ;
    public final void callChain(String layerName, String att) throws RecognitionException {
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:126:40: ( ^( CALL_CHAIN invoke[layerName, att] ) )
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:126:42: ^( CALL_CHAIN invoke[layerName, att] )
            {
    ...
    // $ANTLR start "invoke"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:127:1: invoke[String layerName, String att] : ^(f= FUNCTION . . . target[layerName, att, inputs, inputs, getPrototype((Function) f)] ) ;
    public final void invoke(String layerName, String att) throws RecognitionException {
        StencilTree f=null;

        List<Object[]> inputs = null;
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:129:2: ( ^(f= FUNCTION . . . target[layerName, att, inputs, inputs, getPrototype((Function) f)] ) )
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:129:4: ^(f= FUNCTION . . . target[layerName, att, inputs, inputs, getPrototype((Function) f)] )
            {
    ...
    // $ANTLR start "target"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:131:1: target[String layerName, String att, List<Object[]> inputs, List<Object[]> vals, List<String> prototype] : ( ^(f= FUNCTION . . . target[layerName, att, inputs, invokeGuide((Function) f, vals, prototype), getPrototype((Function) f)] ) | ^(p= PACK . ) );
    public final void target(String layerName, String att, List<Object[]> inputs, List<Object[]> vals, List<String> prototype) throws RecognitionException {
        ...
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:132:2: ( ^(f= FUNCTION . . . target[layerName, att, inputs, invokeGuide((Function) f, vals, prototype), getPrototype((Function) f)] ) | ^(p= PACK . ) )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:132:4: ^(f= FUNCTION . . . target[layerName, att, inputs, invokeGuide((Function) f, vals, prototype), getPrototype((Function) f)] )
                    {
                    ...
                    break;
                case 2 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/interpreter/UpdateGuides.g:133:4: ^(p= PACK . )
                    {
