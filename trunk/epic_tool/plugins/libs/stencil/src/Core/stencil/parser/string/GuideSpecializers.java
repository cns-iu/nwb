// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/GuideSpecializers.g 2009-11-18 17:18:03
...
public class GuideSpecializers extends TreeRewriter {
    ...
    public String getGrammarFileName() { return "/Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/GuideSpecializers.g"; }
    ...
    // $ANTLR start "topdown"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/GuideSpecializers.g:88:1: topdown : ^( GUIDE type= ID ^( SPECIALIZER DEFAULT ) target= ID ) -> ^( GUIDE $type $target) ;
    public final GuideSpecializers.topdown_return topdown() throws RecognitionException {
        ...
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/GuideSpecializers.g:88:8: ( ^( GUIDE type= ID ^( SPECIALIZER DEFAULT ) target= ID ) -> ^( GUIDE $type $target) )
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/GuideSpecializers.g:88:11: ^( GUIDE type= ID ^( SPECIALIZER DEFAULT ) target= ID )
            {
            ...
            // AST REWRITE
            // elements: type, target, GUIDE
            // token labels: target, type
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            // wildcard labels: 
            ...
            {
                // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/GuideSpecializers.g:88:64: ^( GUIDE $type $target)
                {
