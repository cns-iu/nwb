// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g 2009-10-23 23:25:02
...
public class AdHocOperators extends TreeFilter {
    ...
    public String getGrammarFileName() { return "/Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g"; }
    ...
    // $ANTLR start "topdown"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:92:1: topdown : ( ^(r= OPERATOR ( . )* ) | ^(r= OPERATOR_PROXY ( . )* ) | ^(r= PYTHON ( . )* ) | ^(r= LAYER ( . )* ) );
    public final void topdown() throws RecognitionException {
        StencilTree r=null;

        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:93:2: ( ^(r= OPERATOR ( . )* ) | ^(r= OPERATOR_PROXY ( . )* ) | ^(r= PYTHON ( . )* ) | ^(r= LAYER ( . )* ) )
            int alt5=4;
            switch ( input.LA(1) ) {
            case OPERATOR:
                {
            ...
            switch (alt5) {
                case 1 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:93:4: ^(r= OPERATOR ( . )* )
                    {
                    r=(StencilTree)match(input,OPERATOR,FOLLOW_OPERATOR_in_topdown65); if (state.failed) return ;

                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); if (state.failed) return ;
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:93:17: ( . )*
                        loop1:
                        do {
                            int alt1=2;
                    ...
                    break;
                case 2 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:94:4: ^(r= OPERATOR_PROXY ( . )* )
                    {
                    r=(StencilTree)match(input,OPERATOR_PROXY,FOLLOW_OPERATOR_PROXY_in_topdown79); if (state.failed) return ;

                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); if (state.failed) return ;
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:94:23: ( . )*
                        loop2:
                        do {
                            int alt2=2;
                    ...
                    break;
                case 3 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:95:4: ^(r= PYTHON ( . )* )
                    {
                    r=(StencilTree)match(input,PYTHON,FOLLOW_PYTHON_in_topdown93); if (state.failed) return ;

                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); if (state.failed) return ;
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:95:15: ( . )*
                        loop3:
                        do {
                            int alt3=2;
                            int LA3_0 = input.LA(1);

                            if ( ((LA3_0>=ANNOTATION && LA3_0<=93)) ) {
                                alt3=1;
                            }
                            else if ( (LA3_0==UP) ) {
                                alt3=2;
                    ...
                    break;
                case 4 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:96:4: ^(r= LAYER ( . )* )
                    {
                    r=(StencilTree)match(input,LAYER,FOLLOW_LAYER_in_topdown107); if (state.failed) return ;

                    if ( input.LA(1)==Token.DOWN ) {
                        match(input, Token.DOWN, null); if (state.failed) return ;
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/AdHocOperators.g:96:14: ( . )*
                        loop4:
                        do {
                            int alt4=2;
                            int LA4_0 = input.LA(1);

                            if ( ((LA4_0>=ANNOTATION && LA4_0<=93)) ) {
                                alt4=1;
                            }
                            else if ( (LA4_0==UP) ) {
                                alt4=2;
