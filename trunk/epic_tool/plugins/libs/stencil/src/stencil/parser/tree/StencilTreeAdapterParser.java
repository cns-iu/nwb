...
public class StencilTreeAdapterParser extends Parser {
    ...
    // $ANTLR start "entries"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:132:1: entries : (e+= entry )+ -> adapter(clauses=$e);
    public final StencilTreeAdapterParser.entries_return entries() throws RecognitionException {
        ...
        StencilTreeAdapterParser.entry_return e = null;
         e = null;
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:132:8: ( (e+= entry )+ -> adapter(clauses=$e))
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:132:10: (e+= entry )+
            {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:132:11: (e+= entry )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
    ...
    // $ANTLR start "entry"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:133:1: entry : (i= ID EQ v= INT -> {Util.inError($i.text)}? errorEntry(token=$i.textval=$v.text) -> {Util.inDefaults($i.text)}? defaultEntry(token=$i.text) -> entry(token=$i.textval=$v.textclass=Util.lookupClass($i.text)) | ID_IGNORE EQ INT );
    public final StencilTreeAdapterParser.entry_return entry() throws RecognitionException {
        ...
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:133:7: (i= ID EQ v= INT -> {Util.inError($i.text)}? errorEntry(token=$i.textval=$v.text) -> {Util.inDefaults($i.text)}? defaultEntry(token=$i.text) -> entry(token=$i.textval=$v.textclass=Util.lookupClass($i.text)) | ID_IGNORE EQ INT )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:133:9: i= ID EQ v= INT
                    {
                    ...
                    break;
                case 2 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/StencilTreeAdapter.g:137:6: ID_IGNORE EQ INT
                    {
