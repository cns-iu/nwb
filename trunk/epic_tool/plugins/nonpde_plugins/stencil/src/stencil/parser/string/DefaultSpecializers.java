// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g 2009-10-24 00:19:47
...
public class DefaultSpecializers extends TreeRewriteSequence {
    ...
    public String getGrammarFileName() { return "/Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g"; }
    ...
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:108:1: function : ^(f= FUNCTION ^( SPECIALIZER DEFAULT ) args= . op= . target= . ) -> ^( FUNCTION $args $op $target) ;
    public final DefaultSpecializers.function_return function() throws RecognitionException {
        ...
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:109:3: ( ^(f= FUNCTION ^( SPECIALIZER DEFAULT ) args= . op= . target= . ) -> ^( FUNCTION $args $op $target) )
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:109:5: ^(f= FUNCTION ^( SPECIALIZER DEFAULT ) args= . op= . target= . )
            {
            ...
            _last = (StencilTree)input.LT(1);
            f=(StencilTree)match(input,FUNCTION,FOLLOW_FUNCTION_in_function81); if (state.failed) return retval; 
            ...
            _last = (StencilTree)input.LT(1);
            SPECIALIZER1=(StencilTree)match(input,SPECIALIZER,FOLLOW_SPECIALIZER_in_function84); if (state.failed) return retval; 
            ...
            match(input, Token.DOWN, null); if (state.failed) return retval;
            _last = (StencilTree)input.LT(1);
            DEFAULT2=(StencilTree)match(input,DEFAULT,FOLLOW_DEFAULT_in_function86); if (state.failed) return retval; 
            ...
            // AST REWRITE
            // elements: args, target, op, FUNCTION
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
            ...
            {
                // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:110:10: ^( FUNCTION $args $op $target)
                {
    ...
    // $ANTLR start "misc"
    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:112:1: misc : ( ^( GUIDE layer= . type= . ^( SPECIALIZER DEFAULT ) rules= . ) -> ^( GUIDE $layer $type $rules) | ^( OPERATOR_REFERENCE base= . ^( SPECIALIZER DEFAULT ) ) -> ^( OPERATOR_REFERENCE $base) | ^( CANVAS_DEF ^( SPECIALIZER DEFAULT ) (rest= . )* ) -> ^( CANVAS_DEF $rest) );
    public final DefaultSpecializers.misc_return misc() throws RecognitionException {
        ...
        try {
            // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:113:2: ( ^( GUIDE layer= . type= . ^( SPECIALIZER DEFAULT ) rules= . ) -> ^( GUIDE $layer $type $rules) | ^( OPERATOR_REFERENCE base= . ^( SPECIALIZER DEFAULT ) ) -> ^( OPERATOR_REFERENCE $base) | ^( CANVAS_DEF ^( SPECIALIZER DEFAULT ) (rest= . )* ) -> ^( CANVAS_DEF $rest) )
            int alt2=3;
            switch ( input.LA(1) ) {
            case GUIDE:
                {
            ...
            switch (alt2) {
                case 1 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:113:4: ^( GUIDE layer= . type= . ^( SPECIALIZER DEFAULT ) rules= . )
                    {
                    _last = (StencilTree)input.LT(1);
                    {
                    StencilTree _save_last_1 = _last;
                    StencilTree _first_1 = null;
                    _last = (StencilTree)input.LT(1);
                    GUIDE3=(StencilTree)match(input,GUIDE,FOLLOW_GUIDE_in_misc134); if (state.failed) return retval; 
                    ...
                    StencilTree _first_2 = null;
                    _last = (StencilTree)input.LT(1);
                    SPECIALIZER4=(StencilTree)match(input,SPECIALIZER,FOLLOW_SPECIALIZER_in_misc145); if (state.failed) return retval; 
                    ...
                    match(input, Token.DOWN, null); if (state.failed) return retval;
                    _last = (StencilTree)input.LT(1);
                    DEFAULT5=(StencilTree)match(input,DEFAULT,FOLLOW_DEFAULT_in_misc147); if (state.failed) return retval; 
                    ...
                    // token list labels: 
                    // rule list labels: 
                    // wildcard labels: layer, type, rules
                    if ( state.backtracking==1 ) {
                    retval.tree = root_0;
                    ...
                    {
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:114:10: ^( GUIDE $layer $type $rules)
                        {
                        StencilTree root_1 = (StencilTree)adaptor.nil();
                    ...
                    break;
                case 2 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:115:7: ^( OPERATOR_REFERENCE base= . ^( SPECIALIZER DEFAULT ) )
                    {
                    _last = (StencilTree)input.LT(1);
                    {
                    StencilTree _save_last_1 = _last;
                    StencilTree _first_1 = null;
                    _last = (StencilTree)input.LT(1);
                    OPERATOR_REFERENCE6=(StencilTree)match(input,OPERATOR_REFERENCE,FOLLOW_OPERATOR_REFERENCE_in_misc186); if (state.failed) return retval; 
                    ...
                    StencilTree _first_2 = null;
                    _last = (StencilTree)input.LT(1);
                    SPECIALIZER7=(StencilTree)match(input,SPECIALIZER,FOLLOW_SPECIALIZER_in_misc193); if (state.failed) return retval; 
                    ...
                    match(input, Token.DOWN, null); if (state.failed) return retval;
                    _last = (StencilTree)input.LT(1);
                    DEFAULT8=(StencilTree)match(input,DEFAULT,FOLLOW_DEFAULT_in_misc195); if (state.failed) return retval; 
                    ...
                    {
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:116:10: ^( OPERATOR_REFERENCE $base)
                        {
                        StencilTree root_1 = (StencilTree)adaptor.nil();
                    ...
                    break;
                case 3 :
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:117:6: ^( CANVAS_DEF ^( SPECIALIZER DEFAULT ) (rest= . )* )
                    {
                    _last = (StencilTree)input.LT(1);
                    {
                    StencilTree _save_last_1 = _last;
                    StencilTree _first_1 = null;
                    _last = (StencilTree)input.LT(1);
                    CANVAS_DEF9=(StencilTree)match(input,CANVAS_DEF,FOLLOW_CANVAS_DEF_in_misc223); if (state.failed) return retval; 
                    ...
                    StencilTree _first_2 = null;
                    _last = (StencilTree)input.LT(1);
                    SPECIALIZER10=(StencilTree)match(input,SPECIALIZER,FOLLOW_SPECIALIZER_in_misc226); if (state.failed) return retval; 
                    ...
                    match(input, Token.DOWN, null); if (state.failed) return retval;
                    _last = (StencilTree)input.LT(1);
                    DEFAULT11=(StencilTree)match(input,DEFAULT,FOLLOW_DEFAULT_in_misc228); if (state.failed) return retval; 
                    ...
                    // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:117:46: (rest= . )*
                    loop1:
                    do {
                        int alt1=2;
                        int LA1_0 = input.LA(1);

                        if ( ((LA1_0>=ANNOTATION && LA1_0<=93)) ) {
                            alt1=1;
                        }
                    ...
                    {
                        // /Users/jcottam/Documents/workspace/Stencil/Stencil/Core/stencil/parser/DefaultSpecializers.g:118:10: ^( CANVAS_DEF $rest)
                        {
                        StencilTree root_1 = (StencilTree)adaptor.nil();
    ...
    public static final BitSet FOLLOW_FUNCTION_in_function81 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SPECIALIZER_in_function84 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DEFAULT_in_function86 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_GUIDE_in_misc134 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SPECIALIZER_in_misc145 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DEFAULT_in_misc147 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_OPERATOR_REFERENCE_in_misc186 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SPECIALIZER_in_misc193 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DEFAULT_in_misc195 = new BitSet(new long[]{0x0000000000000008L});
    public static final BitSet FOLLOW_CANVAS_DEF_in_misc223 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_SPECIALIZER_in_misc226 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_DEFAULT_in_misc228 = new BitSet(new long[]{0x0000000000000008L});
