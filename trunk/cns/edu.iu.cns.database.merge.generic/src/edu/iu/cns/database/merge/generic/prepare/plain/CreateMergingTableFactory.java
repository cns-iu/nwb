...
public class CreateMergingTableFactory
	...
	private static String[] availableTableNames(Connection connection)
		...
		/* TODO This is ultimately used in ways which would equally well befit a List.
		 * If you're worried about the raw types in DropdownMutator, I'd say don't;
		 * they'll get changed eventually.
		 */
