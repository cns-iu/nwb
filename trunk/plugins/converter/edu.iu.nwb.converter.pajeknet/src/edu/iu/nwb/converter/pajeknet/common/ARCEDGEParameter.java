...
public class ARCEDGEParameter {
	...
	public static final String PARAMETER_HOOK_ONE = "h1";
	public static final String PARAMETER_HOOK_TWO = "h2";
	public static final String PARAMETER_ANGLE_ONE = "a1";
	public static final String PARAMETER_ANGLE_TWO = "a2";
	public static final String PARAMETER_VELOCITY_ONE = "k1";
	public static final String PARAMETER_VELOCITY_TWO = "k2";
	
	public static final String[] ARCEDGE_NUMERIC_PARAMETER_LIST = {PARAMETER_WIDTH,
		PARAMETER_SIZE, PARAMETER_ARROW_POSITION, PARAMETER_LABEL, PARAMETER_LABEL_POSITION, 
		PARAMETER_LABEL_RADIUS, PARAMETER_LABEL_PHI, PARAMETER_LABEL_ANGLE,
		PARAMETER_FONT_SIZE, PARAMETER_HOOK_ONE, PARAMETER_HOOK_TWO, PARAMETER_ANGLE_ONE,
		PARAMETER_ANGLE_TWO, PARAMETER_VELOCITY_ONE, PARAMETER_VELOCITY_TWO};
	public static final String[] ARCEDGE_STRING_PARAMETER_LIST = {PARAMETER_COLOR,
