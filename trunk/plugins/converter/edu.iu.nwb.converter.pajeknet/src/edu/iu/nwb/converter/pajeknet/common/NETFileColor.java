...
public class NETFileColor {
	...
	public static final String[] VERTEX_COLOR_LIST = {NETFileColor.COLOR_APRICOT,
		...
		NETFileColor.COLOR_BLUE,
		NETFileColor.COLOR_BLUE_GREEN,
		NETFileColor.COLOR_BLUE_VIOLET,
		NETFileColor.COLOR_BRICK_RED,
		NETFileColor.COLOR_BROWN,
		NETFileColor.COLOR_BURNT_ORANGE,
		NETFileColor.COLOR_CADET_BLUE,
		NETFileColor.COLOR_CANARY,
		NETFileColor.COLOR_CARNATION_PINK,
		NETFileColor.COLOR_CERULEAN,
		NETFileColor.COLOR_CORNFLOWER_BLUE,
		NETFileColor.COLOR_CYAN,
		NETFileColor.COLOR_DANDELION,
		NETFileColor.COLOR_DARK_ORCHID,
		NETFileColor.COLOR_EMERALD,
		NETFileColor.COLOR_FOREST_GREEN,
		NETFileColor.COLOR_FUCHSIA,
		NETFileColor.COLOR_GOLDENROD,
		NETFileColor.COLOR_GRAY,
		NETFileColor.COLOR_GRAY_05,
		NETFileColor.COLOR_GRAY_10,
		NETFileColor.COLOR_GRAY_15,
		NETFileColor.COLOR_GRAY_20,
		NETFileColor.COLOR_GRAY_25,
		NETFileColor.COLOR_GRAY_30,
		NETFileColor.COLOR_GRAY_35,
		NETFileColor.COLOR_GRAY_40,
		NETFileColor.COLOR_GRAY_45,
		NETFileColor.COLOR_GRAY_55,
		NETFileColor.COLOR_GRAY_60,
		NETFileColor.COLOR_GRAY_65,
		NETFileColor.COLOR_GRAY_70,
		NETFileColor.COLOR_GRAY_75,
		NETFileColor.COLOR_GRAY_80,
		NETFileColor.COLOR_GRAY_85,
		NETFileColor.COLOR_GRAY_90,
		NETFileColor.COLOR_GRAY_95,
		NETFileColor.COLOR_GREEN,
		NETFileColor.COLOR_GREEN_YELLOW,
		NETFileColor.COLOR_JUNGLE_GREEN,
		NETFileColor.COLOR_L_FADED_GREEN,
		NETFileColor.COLOR_L_SKY_BLUE,
		NETFileColor.COLOR_LAVENDER,
		NETFileColor.COLOR_LIGHT_CYAN,
		NETFileColor.COLOR_LIGHT_GREEN,
		NETFileColor.COLOR_LIGHT_MAGENTA,
		NETFileColor.COLOR_LIGHT_ORANGE,
		NETFileColor.COLOR_LIGHT_PURPLE,
		NETFileColor.COLOR_LIGHT_YELLOW,
		NETFileColor.COLOR_LIME_GREEN,
		NETFileColor.COLOR_MAGENTA,
		NETFileColor.COLOR_MAHOGANY,
		NETFileColor.COLOR_MAROON,
		NETFileColor.COLOR_MELON,
		NETFileColor.COLOR_MIDNIGHT_BLUE,
		NETFileColor.COLOR_MULBERRY,
		NETFileColor.COLOR_NAVY_BLUE,
		NETFileColor.COLOR_OLIVE_GREEN,
		NETFileColor.COLOR_ORANGE,
		NETFileColor.COLOR_ORANGE_RED,
		NETFileColor.COLOR_ORCHID,
		NETFileColor.COLOR_PEACH,
		NETFileColor.COLOR_PERIWINKLE,
		NETFileColor.COLOR_PINE_GREEN,
		NETFileColor.COLOR_PINK,
		NETFileColor.COLOR_PLUM,
		NETFileColor.COLOR_PROCESS_BLUE,
		NETFileColor.COLOR_PURPLE,
		NETFileColor.COLOR_RAW_SIENNA,
		NETFileColor.COLOR_RED,
		NETFileColor.COLOR_RED_ORANGE,
		NETFileColor.COLOR_RED_VIOLET,
		NETFileColor.COLOR_ROYAL_BLUE,
		NETFileColor.COLOR_ROYAL_PURPLE,
		NETFileColor.COLOR_RUBINE_RED,
		NETFileColor.COLOR_SALMON,
		NETFileColor.COLOR_SEA_GREEN,
		NETFileColor.COLOR_SEPIA,
		NETFileColor.COLOR_SKY_BLUE,
		NETFileColor.COLOR_SPRING_GREEN,
		NETFileColor.COLOR_TAN,
		NETFileColor.COLOR_TEAL_BLUE,
		NETFileColor.COLOR_THISTLE,
		NETFileColor.COLOR_TURQUOISE,
		NETFileColor.COLOR_VIOLET,
		NETFileColor.COLOR_VIOLET_RED,
		NETFileColor.COLOR_WHITE,
