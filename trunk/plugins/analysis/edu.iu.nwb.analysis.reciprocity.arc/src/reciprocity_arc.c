...
////////////////////////////////////////////////////////////
Number of arcs is determined
Number of arcs involved in reciprocal relation is determined 
////////////////////////////////////////////////////////////
*/
...
int numberofarcs, reciprocity;

void determineReciprocityByArcMethod(int *, int *, int);
  ...
  if(argc > 1)
    {
      ...
      determineReciprocityByArcMethod(sourcenodeid, targetnodeid, numberofedges);
    }
  else
...
void determineReciprocityByArcMethod(int *sourcenodeid, int *targetnodeid, int numberofedges)
{
  int ctr;
  double prevalence;
  ...
  for(ctr=0; ctr < numberofedges; ctr++)
    if(!searchEdgeList(targetnodeid[ctr], sourcenodeid[ctr]))
      reciprocity++;
  reciprocity=reciprocity-numberofselfloops;  
