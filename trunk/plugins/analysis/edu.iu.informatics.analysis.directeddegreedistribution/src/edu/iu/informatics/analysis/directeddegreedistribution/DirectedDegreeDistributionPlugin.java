 ...
 * @author
 */
public class DirectedDegreeDistributionPlugin extends AbstractPlugin {
    //id of this Plugin
    public static final String ID_PLUGIN = "edu.iu.informatics.analysis.directeddegreedistribution";
    
    //basic Plugin information
    private static final String AUTHOR = "Santo Fortunato (and original author(s))";
    private static final String DESCRIPTION 
      = "it calculates the distributions of in- and out- degree for a directed network";
...
//    private static final String DOCUMENTATION_URL = "!FIXME!";
    ...
    /**
     * Creates a new DirectedDegreeDistrPlugin.
     */
	public DirectedDegreeDistributionPlugin() {
...
//		} catch (MalformedURLException e) {}	   
    ...
    public void launch(DataModel model) {
        //this template simple creates a DirectedDegreeDistrAlgorithm and executes it,
        //replace as needed.
    	
        DirectedDegreeDistributionAlgorithm algorithm = new DirectedDegreeDistributionAlgorithm(model);
        algorithm.createGUIandRun(DirectedDegreeDistributionAlgorithm.ALGORITHM_NAME, "");
    }
