      program Avg_shortest_path

!
!     It performs Breadth_First_Search calculating the shortest path between 
!     each pair of nodes. The average shortest path is calculated.
!
...
101         continue
      ...
      avshpath=0.0d0
      do i=1,diameter
         avshpath=avshpath+(real(pathsize(i))/n_paths)*i
      enddo

      write(*,*)'**************************************************************************'
      write(*,127)'The average shortest path between a pair of nodes of the network is ',avshpath
      write(*,*)'**************************************************************************'

127   format(a68,f12.7)
106   format(a256)

      stop
      
    end program Avg_shortest_path
