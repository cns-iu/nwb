...
java -Xms256m -Xmx1000m -classpath "%GCLASSPATH%" -Dsun.java2d.opengl=False "-Dpython.home=%GUESS_HOME%\src" -DgHome="%GUESS_HOME%" -Ddata_label=%8 com.hp.hpl.guess.Guess %1 %2 %3 %4 %5 %6 %7 1> guesslog.txt 2>&1
