...
echo "rsync -rvz --delete epic:/home/epic_website/epic_data/ /home/epic_website/epic_data" >> remote.sh #NOTE: --delete should come up rarely at best . . . And  don't delete the trailing slash
