...
echo "python2.6 manage.py shell --settings=epic.dev_settings < wipeout.py" >> remote.sh
echo "python2.6 manage.py syncdb --noinput --settings=epic.dev_settings" >> remote.sh
