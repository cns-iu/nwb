package edu.iu.informatics.templates;
...
public class TemplatesPlugin extends AbstractUIPlugin {
    //plugin ID
    public static final String ID_PLUGIN = "edu.iu.informatics.templates";
    ...
    public TemplatesPlugin() {
        ...
        if(plugin == null)
            plugin = this;  
        try {
            resourceBundle = ResourceBundle.getBundle("edu.iu.informatics.templates.TemplatesPlugin");
