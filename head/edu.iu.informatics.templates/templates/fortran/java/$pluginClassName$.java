...
public class $pluginClassName$ extends AbstractPlugin {
    ...
    private static final String AUTHOR = "$pluginAuthor$";
    private static final String DESCRIPTION = "$pluginDescription$";
    private static final String CITATION_STRING = "$citationString$";   
    ...
    public void launch(DataModel model) {
        ...
        //replace as needed.
        $algorithmClassName$ algorithm = new $algorithmClassName$(model);
        algorithm.createGUIandRun($algorithmClassName$.NAME, "");        
    }
    ...
    public boolean supports(DataModel model) {
        //template generated code, replace as needed.
        $supportsStatement$
    }
