 ...
 * @author
 */
public class DirectedKNNPlugin extends AbstractPlugin {
    //id of this Plugin
    public static final String ID_PLUGIN = "edu.iu.informatics.analysis.directedknn";
    
    //basic Plugin information
    private static final String AUTHOR = "Santo Fortunato (and original author(s))";
    private static final String DESCRIPTION 
      = "it calculates the degree-degree correlations for a directed network";
...
//    private static final String DOCUMENTATION_URL = "!FIXME!";
    ...
    /**
     * Creates a new DirectedKNNPlugin.
     */
	public DirectedKNNPlugin() {
...
//		} catch (MalformedURLException e) {}	   
    ...
    public void launch(DataModel model) {
        //this template simple creates a DirectedKNNAlgorithm and executes it,
        //replace as needed.
//        DirectedKNNAlgorithm algorithm = new DirectedKNNAlgorithm();
//        algorithm.execute();        
        
        DirectedKNNAlgorithm algorithm = new DirectedKNNAlgorithm(model);
        algorithm.createGUIandRun(DirectedKNNAlgorithm.ALGORITHM_NAME, "");   
    }
