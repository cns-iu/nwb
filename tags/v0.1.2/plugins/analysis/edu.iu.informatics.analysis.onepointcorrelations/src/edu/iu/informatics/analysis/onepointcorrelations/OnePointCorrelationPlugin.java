 ...
 * @author
 */
public class OnePointCorrelationPlugin extends AbstractPlugin {
    //id of this Plugin
    public static final String ID_PLUGIN = "edu.iu.informatics.analysis.onepointcorrelations";
    
    //basic Plugin information
    private static final String AUTHOR = "Santo Fortunato (and original author(s))";
    private static final String DESCRIPTION 
      = "it calculates the correlation between in- and out-degree of a node for a directed network";
...
//    private static final String DOCUMENTATION_URL = "!FIXME!";
    ...
    /**
     * Creates a new OnePointCorrelationPlugin.
     */
	public OnePointCorrelationPlugin() {
...
//	    } catch (MalformedURLException e) {}	   
    ...
    public void launch(DataModel model) {
        //this template simple creates a OnePointCorrelationAlgorithm and executes it,
        //replace as needed.
        OnePointCorrelationAlgorithm algorithm = new OnePointCorrelationAlgorithm(model);
        algorithm.createGUIandRun(OnePointCorrelationAlgorithm.ALGORITHM_NAME, "");
    }
