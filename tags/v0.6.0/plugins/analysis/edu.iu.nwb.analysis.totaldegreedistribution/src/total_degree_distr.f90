...
!
       ...
       integer i,j,k,maxdeg,mindeg,n_vert,n_edges,n_bins,i1,i2,maxind,minind,nattrN,nattrE,n_edges_N,n_edges_E,n_vert0,ch,n_vert1,i0
       integer, allocatable, dimension (:) :: degree,degdis,npoints,np,ind,indc,nodes
       ...
       character*256 filename,fileout2,fileout3,sn_bins
