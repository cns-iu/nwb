 ...
 * @author
 */
public class NwbGraphvizConverterPlugin extends AbstractPlugin {
    //id of this Plugin
    public static final String ID_PLUGIN = "edu.iu.informatics.converter.nwbgraphvizconverter";
    
    //basic Plugin information
    private static final String AUTHOR = "Ben";
    private static final String DESCRIPTION = "Convert a GraphViz DOT to and from NWBModel";
    private static final String CITATION_STRING = "http://zvtm.sourceforge.net/zgrviewer/doc/ajapad/dotParser.html";
    private static final String UNSUPPORTED_REASON = "Data Model not supported";
    private static final String DOCUMENTATION_URL = "Uses http://zvtm.sourceforge.net/zgrviewer/doc/ajapad/dotParser.html";
    
    /**
     * Creates a new NwbGraphvizConverterPlugin.
     */
	public NwbGraphvizConverterPlugin() {
    ...
    public void launch(DataModel model) {
        //this template simple creates a NwbGraphvizConverterAlgorithm and executes it,
        //replace as needed.
        NwbGraphvizConverterAlgorithm algorithm = new NwbGraphvizConverterAlgorithm(model);
        algorithm.execute();
    }
    ...
    public boolean supports(DataModel model) {
        ...
        return model.getData() instanceof NWBModel || model.getData() instanceof Graph;
    }
