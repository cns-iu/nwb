// Single Link Clustering of Layout output
//
// This program performs single link clustering on the results of layout.
...
// threshold for use by the single link clustering algorithm.  This
...
{	
    ...
    */
    ...
    // call single link algorithm
    cout << "Computing single link clustering ..." << endl;

    int line_count;
    int pid1, pid2;
    float dist, x1, y1, x2, y2;
    single_link cluster ( node_info.size()-1, command_line.threshold );
