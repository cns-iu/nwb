...
public class BalloongraphVisualization {
	 ...
	 * Sets the input Tree.
	 * 
	 * @param tree The Tree that this visualization will use.
	 */
	public void setInput(Tree tree) {
		BalloongraphVisualization.tree = tree;
	}		
	
	/**
	 * Shows the visualization for the Tree that was set with the
	 * setInput(Tree) method.
	 */
	public void show() {
		try {
	...
	/*
	 * initialize the renderers used in the visualization
	 */
	private void initializedRenderers(){
	...
	/*
	 * initialize the ActionLists used in the visualization
	 */
	...
	/*
	 * initialize the Display used by the visualization
	 */
