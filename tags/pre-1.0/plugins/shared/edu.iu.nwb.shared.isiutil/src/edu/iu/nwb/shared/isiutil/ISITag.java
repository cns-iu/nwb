...
public class ISITag {
	...
	public static final ISITag AUTHORS                            = new ISITag("AU", "Authors", ContentType.MULTI_VALUE_TEXT, "\n");
	public static final ISITag BEGINNING_PAGE                     = new ISITag("BP", "Beginning Page", ContentType.TEXT);
	public static final ISITag RESEARCH_ADDRESSES                 = new ISITag("C1", "Research Addresses", ContentType.MULTI_VALUE_TEXT, "\n");
	...
	public static final ISITag TWENTY_NINE_CHAR_JOURNAL_ABBREV    = new ISITag("J9", "Journal Name (Abbreviated)", ContentType.TEXT);
	public static final ISITag ISO_JOURNAL_TITLE_ABBREV           = new ISITag("JI", "Journal Name (Abbreviated ISO)", ContentType.TEXT);
	...
	private static final ISITag[] isiTagArray = { FILE_TYPE, VERSION_NUMBER,
		...
		PUBLISHER_WEB_ADDRESS, AUTHORS_FULL_NAMES, EMAIL_PRIMARY_AUTHOR
	};
