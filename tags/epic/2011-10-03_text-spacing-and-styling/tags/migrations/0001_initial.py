...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('tags', ['Tagging'])

        # Adding unique constraint on 'Tagging', fields ['tag', 'item']
        db.create_unique('tags_tagging', ['tag', 'item_id'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'Tagging'
        db.delete_table('tags_tagging')

        # Removing unique constraint on 'Tagging', fields ['tag', 'item']
        db.delete_unique('tags_tagging', ['tag', 'item_id'])
    ...
    models = {
        ...
        'tags.tagging': {
            'Meta': {'unique_together': "(('tag', 'item'),)", 'object_name': 'Tagging'},
