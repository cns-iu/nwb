...
class ItemDescriptionMarkupTestCase(CustomTestCase):
    ...
    def setUp(self):
        ...
        self.view_datarequest1_url = reverse(
            ...
            kwargs=view_datarequest1_url_kwargs)
        
        
        view_dataset1_url_kwargs = {
            'item_id': self.dataset1.id,
            'slug': self.dataset1.slug,
        }
        
        self.view_dataset1_url = reverse(
            'epic.datasets.views.view_dataset',
            kwargs=view_dataset1_url_kwargs)
        
        
        view_project1_url_kwargs = {
        ...
        self.view_project1_url = reverse(
            ...
            kwargs=view_project1_url_kwargs)
        
        
        self.view_browse_all_url = reverse('epic.core.views.browse')
        self.view_browse_datarequests_url = \
            reverse('epic.datarequests.views.view_datarequests')
        self.view_browse_datasets_url = \
            reverse('epic.datasets.views.view_datasets')
        self.view_browse_projects_url = \
