...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectDownload'
        db.create_table('projects_projectdownload', (
            ('downloaded_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_index=True, blank=True)),
            ('parent_project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='downloaded_project', to=orm['projects.Project'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('downloader', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('projects', ['ProjectDownload'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ProjectDownload'
        db.delete_table('projects_projectdownload')
