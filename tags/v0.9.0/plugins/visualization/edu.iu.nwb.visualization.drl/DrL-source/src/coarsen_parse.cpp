...
void parse::print_syntax( const char *error_string )
{
  ...
  cout << endl << "Single Link Based Coarsening" << endl
	   <<         "----------------------------" << endl
	   << "S. Martin" << endl
	   << "Version " << VERSION << endl << endl
	   << "This program provides coarsening of a sim file based on" << endl
       << "the single link clustering of the results of layout." << endl << endl
	   ...
	   << "root_file_(l-1).clust is the output file from the single link" << endl
