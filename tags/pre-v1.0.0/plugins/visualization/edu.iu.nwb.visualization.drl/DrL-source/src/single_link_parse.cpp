...
void parse::print_syntax( const char *error_string )
{
  ...
  cout << endl << "Single Link Clustering" << endl
	   <<     "----------------------" << endl
	   << "S. Martin" << endl
	   << "Version " << VERSION << endl << endl
	   << "This program provides single link clustering of the results" << endl
	   << "of layout." << endl << endl
	   << "Usage: single_link [options] root_file" << endl << endl
       ...
       << "  the single link clustering, with the format" << endl
