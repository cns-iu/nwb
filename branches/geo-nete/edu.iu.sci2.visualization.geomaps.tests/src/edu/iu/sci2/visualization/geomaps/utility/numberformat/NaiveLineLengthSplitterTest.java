...
public class NaiveLineLengthSplitterTest extends TestCase {
	...
	private static final ImmutableList<String> SPLIT_BASE_STRING =
			ImmutableList.of(
					//  5  5  5  3  5 12    = 32<=40 and 10 more would make 42 > 40
					"Lorem ipsum dolor sit amet; consectetuer",
					// 10  5  3  4  7  4  7 = 40<=40 and  9 more would make 49 > 40
					"adipiscing elit; sed diam nonummy nibh euismod",
					//  9  2  7  6  5  7  4 = 40<=40 and  9 more would make 49 > 40
					"tincidunt ut laoreet dolore magna aliquam erat",
					//  9                   =  9<=40 and we're done
					"volutpat.");
	...
	public static void testSplit() {
		assertEquals(
				EXPECTED_SPLIT,
				NaiveLineLengthSplitter
						.targetingLineLength(TARGETED_PHRASE_LENGTH)
						.split(TEST_STRING));
	}
}
