...
public class ColorTuples {
	...
	public static final Function<Float, Double> DOUBLE_VALUE_OF =
			new Function<Float, Double>() { @Override
			public Double apply(Float f) { return f.doubleValue(); }};
	public static final Function<Double, Float> FLOAT_VALUE_OF =
			new Function<Double, Float>() { @Override
			public Float apply(Double d) { return d.floatValue(); }};
	...
	public static final Function<Color, double[]> AS_TUPLE =
			new Function<Color, double[]> () { @Override
			public double[] apply(Color c) { return asTuple(c); }};
	...
	public static final Function<double[], Color> AS_COLOR =
			new Function<double[], Color> () { @Override
			public Color apply(double[] t) { return asColor(t); }};
}