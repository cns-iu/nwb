...
public class CropGeometryBuilder {
	...
	/**
	 * Draw a rhombus (in latitude & longitude space) centered on meridian from the north pole to
	 * the south pole with the specified constant width at the equator.
	 * 
	 * This is an approximation to the space surrounding the given meridian.
	 */
	public static Geometry createMeridianCropGeometry(double meridian) {
