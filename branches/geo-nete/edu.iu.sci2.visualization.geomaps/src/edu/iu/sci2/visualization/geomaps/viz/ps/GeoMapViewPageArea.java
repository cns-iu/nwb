...
public class GeoMapViewPageArea {
	...
	private static double calculateDisplayCenterY(double displayHeightInPoints) {
		return (Constants.PAGE_FOOTER_HEIGHT_IN_POINTS
				+ Constants.LEGEND_PAGE_AREA_HEIGHT_IN_POINTS + (displayHeightInPoints / 2.0)); //Constants.LEGEND_PAGE_AREA_DIMENSION_IN_POINTS.getHeight() + (displayHeightInPoints / 2.0));
	}
