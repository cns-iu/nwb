...
public class StencilController {
	...
	/**
	 * This method is used to end the stencil instance properly. Josepg Cottam (creator of Stencil)
	 * mentioned in order to avoid memory leak problems we need to send a shut-down signal to the
	 * Stencil processes. This is done by calling signalStop() method on the current active stencil
	 * panel.  
	 */
	public void shutdownStencil() {
