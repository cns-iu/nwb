...
public class StencilGUI {
	...
	public StencilGUI(Properties properties,
		...
		stencil.Configure.loadProperties(properties);
	...
	private void doPreWindowDisposeProcedure() {
		
		/*
		 * This method makes sure that stencil's references are cleaned up which are spawned due to
		 * multi-threading painting.
		 * */
		this.controller.shutdownStencil();
	}
