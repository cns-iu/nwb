...
S. Martin, W. M. Brown, K. Boyack, "Dr. L: Distributed Recursive 
(Graph) Layout," in prepartion for Journal of Graph Algorithms and 
Applications.

Please check back here for the full citation, which will hopefully
...
Important NOTE: all programs in the DrL library have documentation 
