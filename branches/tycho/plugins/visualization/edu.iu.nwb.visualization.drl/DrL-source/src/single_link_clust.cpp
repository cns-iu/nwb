// This file contains the member definitions of the single_link class

// The single_link class contains the ported awk code from Kevin Boyack.
...
// The function single_link contains the awk single link code.
...
void single_link::next_line ( int pid1, int pid2, float dist,
...
// This routine outputs the results of the single link clustering
// algorithm.

void single_link::output_clusters ( string filename, map < int, node> &node_info )
{
