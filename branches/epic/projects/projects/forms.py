...
class AddDatasetToProjectForm(forms.Form):
    dataset_url = forms.CharField(label='Add Dataset From This URL',
                                 required=False)
...
AddDatasetToProjectFormSet = formset_factory(AddDatasetToProjectForm)
RemoveDatasetFromProjectFormSet = \
    formset_factory(RemoveDatasetFromProjectForm)
