...
@register.inclusion_tag('templatetags/datarequest_list_short.html', takes_context=True)
def datarequest_list_short(context, datarequests=None):
    return {'datarequests': datarequests, 'user': context['user']}

@register.inclusion_tag('templatetags/datarequest_list_tiny.html', takes_context=True)
def datarequest_list_tiny(context, datarequests=None):
    return {'datarequests': datarequests, 'user': context['user']}

@register.inclusion_tag('templatetags/recently_fulfilled_requests.html', takes_context=True)
...
@register.inclusion_tag('templatetags/fulfills_request_button.html', takes_context=True)
