...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_item', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=256))


    def backwards(self, orm):
        
        # Changing field 'Item.slug'
        db.alter_column('core_item', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'core.author': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'authors'", 'null': 'True', 'to': "orm['core.Item']"})
        },
        'core.item': {
            'Meta': {'object_name': 'Item'},
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'categories'", 'blank': 'True', 'to': "orm['categories.Category']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
        ...
        'core.profile': {
            ...
            'has_activated_account': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
