...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datarequests_datarequest', (
            ('status', self.gf('django.db.models.fields.CharField')(default='U', max_length=1, db_index=True)),
            ('fulfilling_item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fulfilled_requests', blank=True, null=True, to=orm['core.Item'])),
            ('item_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Item'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('datarequests', ['DataRequest'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'DataRequest'
        db.delete_table('datarequests_datarequest')
    ...
    models = {
        ...
        'datarequests.datarequest': {
            'Meta': {'object_name': 'DataRequest', '_ormbases': ['core.Item']},
            'fulfilling_item': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'fulfilled_requests'", 'blank': 'True', 'null': 'True', 'to': "orm['core.Item']"}),
