...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('messages_message', (
            ...
            ('message', self.gf('django.db.models.fields.CharField')(max_length=16384)),
        ...
        db.create_table('messages_receivedmessage', (
            ('read', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('replied', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('message_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['messages.Message'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('messages', ['ReceivedMessage'])

        # Adding model 'SentMessage'
        db.create_table('messages_sentmessage', (
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('message_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['messages.Message'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('messages', ['SentMessage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('messages_receivedmessage')

        # Deleting model 'SentMessage'
        db.delete_table('messages_sentmessage')
