...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('core_item', 'category_id')


    def backwards(self, orm):
        
        # Adding field 'Item.category'
        db.add_column('core_item', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['categories.Category']), keep_default=False)
