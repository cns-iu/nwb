...
//	protected static Map<String, String> lookup = loadLookup();
	...
	protected Map<Integer, Integer> totals = new HashMap<Integer, Integer>();
	private int idsHit = 0;
	private String nodeValueColumnName;
	
	public MapOfScience(Map<Integer, Integer> found, String nodeValueColumnName) {		
//		int total = 0;
...
//	public MapOfScience(Map<Integer, Double> totals) {
//		this.totals = totals;
//	}
...
//	}
	...
	public String getPostScript() {
		...
		int minArea = Collections.min(totals.values());
		int maxArea = Collections.max(totals.values());
		...
		mapTemplate.setAttribute("keyLabel", "Circle Area: " + nodeValueColumnName);
		mapTemplate.setAttribute(
