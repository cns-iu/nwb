...
public class CoreToLeafBipartiteNetworkQueryConstructor extends BasicNetworkQueryConstructor {
	public static final String CORE_TO_LEAF_STRING_TEMPLATE_FILE_PATH = "core_leaf_bipartite.st";
	...
	public CoreToLeafBipartiteNetworkQueryConstructor(
